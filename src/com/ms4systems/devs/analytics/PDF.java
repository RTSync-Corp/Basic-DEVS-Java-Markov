...
public class PDF {// elements are symbols
	...
	public double measureOfIndependence(String[] elx, String[] ely) {
		...
		// Hashtable ht = joint.sortedDifferences(pdfInd);
	...
	public static void main(String[] args) {
		// PDF pdf = makePDF(new String[] { "a", "b" }, new double[] { .4, .6
		// });
		// pdf.print();
		// Hashtable<String, Double> map = new Hashtable<String, Double>();
		// map.put("a",1.);
		// map.put("b", 2.);
		// // PMF pmf = pdf.mapToPMF(map);
		// PMF pmf = pdf.mapToPMF();
		// pmf.print();
		// System.out.println(pmf.getMean());
		PDF pdf = makeJointPDF(new String[] { "a", "b" }, new String[] { "a",
				"b" }, new double[][] { { 0.25, 0.25 }, { 0.25, .25 } });
		// pdf.print();
		// PDF pdfx = pdf.getMarginalXPDF(new String[] {"a","b"},
		// new String[] {"a","b"});
		// pdfx.print();
		// PDF pdfy = pdf.getMarginalYPDF(new String[] {"a","b"},
		// new String[] {"a","b"});
		// pdfy.print();
		// PDF pdfind = makeJointIndependent( pdfx, pdfy,new String[] {"a","b"},
		// new String[] {"a","b"});
		// pdfind.print();
		// double dif = pdf.sumSquareDifferences(pdfind);
		// System.out.println(dif);
		// pdf.measureOfIndependence(new String[] {"a","b"},
		// new String[] {"a","b"});
		//

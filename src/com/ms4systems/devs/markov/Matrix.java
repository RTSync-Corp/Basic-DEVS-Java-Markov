...
public class Matrix {
	...
	// public void setColumn(int i, double[] col){
...
//				"C:\\Users\\Bernie\\Documents\\CoordCare\\Markov\\src\\Models\\txt\\"
//						+ fname + ".xml", s);
	...
	public static void main(String[] args) {
		...
		// m.writeXML("RandCTProd12");
		// ContinuousTimeMarkov ctm = new ContinuousTimeMarkov();
		// ctm.fillTransitionInfoList("RandCT1.xml");
		// MarkovMat mm = new MarkovMat();
		// ctm.setInitialStateAndTransitionMatrix(mm);
		// mm.TransitionMatrix.print();
		Matrix l = m.lump(3);

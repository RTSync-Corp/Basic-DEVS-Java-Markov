...
public class SampleFromExponential extends SampleFromDistribution{
	...
	//	System.out.println(pmfMin.getLowestNonZero()+" "+pmfMin.getHighestNonZero()+" "+pmfMax.getLowestNonZero()+" "+pmfMax.getHighestNonZero());
	//		System.out.println(pmfMax.getMean());
	//	System.out.println(pmfMax.getStd());

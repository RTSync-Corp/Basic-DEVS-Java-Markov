...
import com.ms4systems.devs.analytics.PMF;
...
//				double sumFrombini = 0;
//				for (double j = i;j<= getHighestNonZero()/binsize;j++){
//					double binj = binsize*j;
//					if (h.get(binj) != null)
//					sumFrombini+= h.get(binj);
//				}
//				if (h.get(bini) != null)
//					pmf.put(bini,h.get(bini)/sumFrombini);

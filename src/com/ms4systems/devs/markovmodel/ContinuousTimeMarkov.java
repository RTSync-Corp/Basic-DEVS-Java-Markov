...
public class ContinuousTimeMarkov extends AtomicModelImpl implements PhaseBased,
    ...
    //        // change confluentTransition with internalTransition first (by default)
    // 
...
//                //ID:EXT:WaitForHello:inHello
//                Message<ArrayList> m = messageList.get(0);
//                ArrayList<TransitionInfo> tl =
//                    (ArrayList<TransitionInfo>) m.getData();
//                //               replaceTransitions(tl);
//                previousPhase = null;
//
//                //ENDID

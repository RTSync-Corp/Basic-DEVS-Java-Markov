...
public class MarkovMat extends AtomicModelImpl implements PhaseBased,
    ...
    public void initialize() {
        ...
        //column probabilities must sum to 1

        //        stateVector = new double[] { 0, 0, 1 };
        //
        //        TransitionMatrix = new Matrix(3);//stagnant,bear,bull
        //        TransitionMatrix.setColumn(0,  new double[] {.5,0.25,0.25});//stagnant
        //        TransitionMatrix.setColumn(1, new double[] {0.05,.8,.15});//bear
        //        TransitionMatrix.setColumn(2, new double[] {0.25,0.075,1-0.25-0.075});//bull
        //        TransitionMatrix.print();
        
//        this.TransitionMatrix.setColumn(0,
//                new double[] { .5, .5, 0, 0 });
//           this.TransitionMatrix.setColumn(1,
//          		 new double[] { .5, .5, 0, 0 });
//           this.TransitionMatrix.setColumn(2,
//        		   new double[] { 0, 0, .5, .5 });
//            this.TransitionMatrix.setColumn(3,
//          		   new double[] { 0, 0, .5, .5 });
//         Matrix EpsMatrix = new Matrix(4);
//         double eps = .1;
//         EpsMatrix.setColumn(0,
//                new double[] { -eps*.5, 0,eps*.5, 0 });
//          EpsMatrix.setColumn(1,
//          		 new double[] { 0, -eps*.5, 0, eps*.5 });
//           EpsMatrix.setColumn(2,
//        		   new double[]{ eps*.5, 0,-eps*.5, 0 });
//          EpsMatrix.setColumn(3,
//          		   new double[] { 0, eps*.5, 0, -eps*.5 });
//          this.TransitionMatrix = 
//               this.TransitionMatrix.Plus(EpsMatrix);
